...
class DirectoryAdapter extends RecyclerView.Adapter<DirectoryAdapter.DirectoryViewHolder> {
    ...
    public void onBindViewHolder(DirectoryViewHolder holder, int position) {
        ...
        if (currentFile.isFile()) {
            CharSequence date = DateUtils.getRelativeTimeSpanString(holder.mFileTitle.getContext(),
                    currentFile.lastModified(), true);

            holder.mFileModifiedDate.setText(date);
        } else {
            holder.mFileModifiedDate.setText("");
        }
    }
    ...
    static class DirectoryViewHolder extends RecyclerView.ViewHolder {
        ...
        private TextView mFileModifiedDate;
        ...
        DirectoryViewHolder(View itemView, final OnItemClickListener clickListener) {
            ...
            mFileModifiedDate = itemView.findViewById(R.id.item_file_last_modified);
        }
    }
}